...
WaveshareEPaper4P2InB = waveshare_epaper_ns.class_('WaveshareEPaper4P2InB', WaveshareEPaper)
...
WaveshareEPaper7P5InV2B = waveshare_epaper_ns.class_('WaveshareEPaper7P5InV2B', WaveshareEPaper)
...
MODELS = {
    ...
    '4.20in-b' : ('b', WaveshareEPaper4P2InB),
    '5.83in': ('b', WaveshareEPaper5P8In),
    '7.50in': ('b', WaveshareEPaper7P5In),
    '7.50inv2': ('b', WaveshareEPaper7P5InV2),
    '7.50inv2b': ('b', WaveshareEPaper7P5InV2B),
}
...
def validate_full_update_every_only_type_a(value):
    ...
    if MODELS[value[CONF_MODEL]][0] != 'a':
        raise cv.Invalid("The 'full_update_every' option is only available for models "
                         "'1.54in', '2.13in', '2.90in', '2.90inV2', and '2.90inV2B'.")
    return value
